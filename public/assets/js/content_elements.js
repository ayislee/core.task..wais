		...
		if ( mapElement )
		{
			...
			locations.each(function() {
                ...
                markers.forEach(element => {
                    ...
                    console.log(element)
                    lat_sum += parseFloat(element.lat);
				    lng_sum += parseFloat(element.lng);
                    ...
                    '<div id="siteNotice">' +
                    "</div>" +
                    '<div class="map-store">' + element.store + '</div>' +
                    '<div id="bodyContent"><p>' + element.address + '</p>' +
                    "<p>" + element.open_day+ "</p>" +
                    "<p>" + element.open_time+ "</p>" +
                    "</div>" +
                    "</div>";
